...
const cn = {
  ...
  Error: {
    Unauthorized: isApp
      ? `😆 对话遇到了一些问题，不用慌:
       \\ 请联系网站管理员@006lp寻求帮助
       \\ 联系方式：[Telegram](https://t.me/lpsuki)、[X(原Twitter)](https://x.com/006lpsuki)或[Email](mailto:kirakirai8023@gmail.com)`
      : `😆 对话遇到了一些问题，不用慌:
       \ 看起来你并没有登录呢，点击[这里](/#/auth)输入访问秘钥 🔑
       \ 没有秘钥？请联系网站管理员@006lp寻求帮助
       \ 联系方式：[Telegram](https://t.me/lpsuki)、[X(原Twitter)](https://x.com/006lpsuki)或[Email](mailto:kirakirai8023@gmail.com)
       `,
  },
  Auth: {
